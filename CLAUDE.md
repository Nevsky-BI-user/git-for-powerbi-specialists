...
- Перша згадка будь-якої ПРОГРАМИ в курсі — одразу поруч візуал «як вона виглядає на ПК» (uimock-схема або term-win-приклад), а не лише текстове визначення.
- Абстрактна КОНЦЕПЦІЯ (гілка, HEAD, staging, знімки, merge…) пояснюється РАЗОМ зі схемою/діаграмою в місці пояснення (gplayer/uimock/term-win поруч з tdef), а не текстом «для машини»; кілька абзаців теорії підряд без візуала між ними — прогалина.
